        ...
        <div className='bg-white-100 w-full text-sm  min-h-screen h-full flex flex-col items-center'>
          ...
          <div className='flex gap-3 my-4 bg-white w-full md:w-1/2 p-5 h-min rounded-md'>
            <div className="relative w-full">
              ...
              <input onChange={(e) => debounced(e.target.value)} type="text" className="py-3 w-full bg-gray-100 placeholder:text-gray-700 rounded-md pl-10 focus:outline-none" placeholder="Start Searching..." />
